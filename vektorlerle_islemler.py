...
def my_Vector_Addition(v,w):#vektörel toplam
  my_result=[]
...
def my_Vector_Substraction(v,w):#vektörel çıkarma
  size=len(v)
  my_result=[]
  for i in range (size):
    my_result.append(0)
...
def my_Vector_Scalar_Product(v,alpha):#skaler çarpma
  size=len(v)
  my_result=[]
  for i in range (size):
    my_result.append(0)
...
def my_Vectors_Inner_Product(v,w):#vektörel çarpma
  size=len(v)
  my_result=[]
  for i in range (size):
    my_result.append(0)
